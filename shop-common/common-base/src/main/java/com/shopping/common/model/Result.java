package com.shopping.common.model;


import com.shopping.common.contanst.BusinessEnum;
import lombok.AllArgsConstructor;
import lombok.Data;
import lombok.NoArgsConstructor;

import static com.shopping.common.contanst.BusinessEnum.OPERATION_FALL;
import static com.shopping.common.contanst.BusinessEnum.OPERATION_SUCCESS;
...
public class Result<T> {
	...
	public static Result<String> handle(Boolean flag) {
		...
		return Result.fail(OPERATION_FALL.getMsg());
	}
